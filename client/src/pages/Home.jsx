        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Discover comfortable and affordable hostel accommodations across the country. 
              Book your stay with confidence and enjoy a memorable experience.
            </p>
...
const features = [
  {
    ...
    description: 'All our hostels are verified and regularly inspected to ensure quality standards.',
    icon: (props) => (
